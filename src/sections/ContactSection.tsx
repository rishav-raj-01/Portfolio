...
export default function ContactSection() {
  return (
    ...
    >
      ...
      {/* Contact Links */}
      <div className="max-w-xl mx-auto flex flex-col gap-5 items-center text-center">
        ...
        {links.map((link, i) => (
          <FadeIn key={link.href} delay={0.2 + i * 0.07} y={20} className="w-full">
            <a
              href={link.href}
              target={link.href.startsWith('http') ? '_blank' : undefined}
              rel="noopener noreferrer"
              id={`contact-${link.value.replace(/[^a-zA-Z0-9]/g, '-').toLowerCase()}`}
              className="group flex flex-col gap-0.5 border-b pb-4 transition-opacity hover:opacity-80 items-center"
        ...
        <FadeIn delay={0.55} y={20}>
          <div className="mt-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="contact-pill px-8 py-3 sm:px-10 sm:py-3.5 text-xs sm:text-sm uppercase tracking-widest"
            >
              SEND AN EMAIL
            </a>
          </div>
        ...
        <div className="mt-20 sm:mt-32 pt-10 sm:pt-16 border-t" style={{ borderColor: 'rgba(215,226,234,0.08)' }}>
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-8 md:mb-12">
            ...
            <div className="flex items-center gap-4 mt-8 md:mt-0">
              <a href="https://github.com/rishav-raj-01" target="_blank" rel="noopener noreferrer" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-[#D7E2EA]/20 flex items-center justify-center hover:bg-[#D7E2EA]/10 transition-colors text-[#D7E2EA]">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
              </a>
              <a href="https://www.linkedin.com/in/rishav-raj-7a6544362/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-[#D7E2EA]/20 flex items-center justify-center hover:bg-[#D7E2EA]/10 transition-colors text-[#D7E2EA]">
